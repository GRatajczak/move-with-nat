...
import { CreateClientFormSchema } from "@/lib/validation";
...
import type { CreateClientFormData, CreateClientFormProps } from "@/interface";

export const CreateClientForm = ({ onSubmit, onCancel, isSubmitting }: CreateClientFormProps) => {
  const defaultValues: CreateClientFormData = {
    email: "",
    firstName: "",
    lastName: "",
    phone: "",
        ...
        <FormField
          ...
          render={({ field }) => (
            <FormItem>
              ...
              <FormDescription>
                Adres email podopiecznego. Link aktywacyjny zostanie wysłany na ten adres.
              </FormDescription>
              <FormMessage />
            </FormItem>
          )}
